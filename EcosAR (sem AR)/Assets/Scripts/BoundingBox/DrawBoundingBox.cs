...
public class DrawBoundingBox : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _isBeingTrackedWindTarget = true;// VuforiaTools.IsBeingTracked("Wind Target");
        _isBeingTrackedSceneTarget = true;// VuforiaTools.IsBeingTracked("Scene Target");
        _isBeingTrackedTemperatureTarget = true;// VuforiaTools.IsBeingTracked("Temperature Target");
